...
const Services = () => {
  return (
    <div className="py-14 px-4 mx-auto flex flex-col justify-between items-center bg-white text-black">
      <div className="flex flex-col text-center justify-between gap-1 items-center max-w-[640px]">
        <h1 className="font-bold text-xl lg:text-2xl tracking-tight">
          Full Service Digital Marketing Agency
        </h1>
        <button className=" my-1 text-xs md:text-sm text-blue-800 font-bold tracking-tight">
          Read More -{">"}
        </button>

        <p className="font-light my-1 max-w-[550px]">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 text-black my-5 gap-4">
        {/* item */}
        <div className="shadow-lg rounded-lg max-w-[155px] p-4 hover:bg-gradient-to-r hover:from-purple-400 hover:to-purple-700 hover:text-white transition ease-out duration-300">
          <div className="flex flex-col justify-center ">
            <BsBuilding className="text-4xl" />
            <h2 className="text-md font-bold">Lorem, ipsum.</h2>
            <p className="text-[10px] font-medium py-2">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit.
              Pariatur, ullam harum. Expedita!
            </p>
          </div>
          <button className="text-sky-400 text-[11px] font-medium tracking-wide flex justify-between items-center hover:text-white duration-300">
